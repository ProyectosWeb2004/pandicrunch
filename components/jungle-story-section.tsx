					...
					{storySteps.map((step, index) => (
						...
						>
							...
							<div className={`relative ${index % 2 === 1 ? "lg:col-start-1" : ""}`}>
								...
								<Card className="relative border-0 bg-white/90 shadow-lg overflow-hidden rounded-b-2xl">
									<CardContent className="p-0">
										...
										/>
										<div className="p-6 bg-gradient-to-t from-white to-transparent rounded-b-2xl">
